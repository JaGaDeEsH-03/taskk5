...
var pickedColor = colors[Math.floor(Math.random() * 9)];
...
hardBtn.addEventListener("click", function() {
    ...
    this.style.background = "rgb(233, 119, 119)";
    this.style.color = "white";
    intermediate.style.background = "white";
    intermediate.style.color = "rgb(233, 119, 119)";
...
intermediate.addEventListener("click", function() {
    ...
    boxCount = 9;
    colors = generateRandomColor(boxCount);
    pickedColor = colors[Math.floor(Math.random() * 9)];
...
function win() {
    ...
    statusText.textContent = "amazing....!!";
}
